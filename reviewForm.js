...
reviewInformation.innerHTML += "<p><strong>CREDENTIALS TO BE SUBMITTED:</strong> " + checkedCredentials.join(", ") + "</p>";
  ...
  var pgContact = document.getElementById("pg-contact-number");
  reviewInformation.innerHTML += "<p><strong>CONTACT NUMBER:</strong> " + pgContact.value + "</p>";
  ...
  if (signatureData) {
      ...
      reviewInformation.innerHTML += "<p><strong>Signature:</strong><br><img src='" + pictureUrl + "' alt='Uploaded Signature' style='width: 200px;'></p>";
  } else {
